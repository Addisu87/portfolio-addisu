...
(${formData.email})
	...
	return (
		<div className="relative min-h-screen flex flex-col items-center justify-start px-4 md:px-10 mx-auto max-w-7xl">
			{/* Fixed position header section */}
			<div className="w-full sticky top-0 bg-[rgb(36,36,36)] pt-24 pb-8 z-10">
				<h3 className="uppercase tracking-[20px] text-gray-500 text-2xl text-center">
					Contact
				</h3>
				<h4 className="text-sm uppercase text-gray-500 text-center tracking-[3px] mt-4">
					Let&apos;s discuss your next project
				</h4>
			</div>

			{/* Scrollable content section */}
			<div className="w-full max-w-2xl flex-grow flex flex-col justify-start gap-8 py-8">
