...
function Skill({ directionLeft }: Props) {
  return (
    ...
    >
      <Image
        className="rounded-full border border-gray-500 object-cover w-24 h-24 md:w-28 md:h-28 xl:w-30 xl:h-30 filter group-hover:grayscale transition duration-300 ease-in-out"
        src={ReactIcon}
        alt="react-icon"
        width={50}
        height={50}
