...
function Skill({ skill, directionLeft }: Props) {
  return (
    ...
    >
      ...
      <div className="absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-20 w-20 md:w-20 md:h-20 xl:w-24 xl:h-24 rounded-full z-0">
